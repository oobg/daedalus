...
export default function FloorSidebar() {
  ...
  return (
    <aside className="w-52 flex flex-col bg-white border-r border-[#d4d4c8] shrink-0">
      {/* Floors */}
      <div className="p-3 border-b border-[#d4d4c8]">
        <div className="flex items-center justify-between mb-2">
          <span className="text-xs font-semibold text-[#888880] uppercase tracking-wide">층</span>
          <button
            onClick={addFloor}
            className="text-xs px-2 py-0.5 bg-[#f0efeb] hover:bg-[#e8e8e0] rounded"
          >
            + 추가
          </button>
        </div>
      ...
      {activeFloorId && (() => {
        ...
        return (
          <div className="p-3 border-b border-[#d4d4c8] space-y-2">
            <p className="text-xs font-semibold text-[#888880] uppercase tracking-wide mb-1">층 설정</p>
            <div>
            ...
            <div>
              <label className="text-xs text-[#888880]">높이 (m)</label>
              <input
                type="number"
                min={0.5}
                step={0.5}
            ...
            <button
              ...
              className="w-full text-xs px-2 py-1.5 bg-[#f0efeb] hover:bg-[#e8e8e0] rounded text-[#555548]"
            >
            ...
            {floor.referenceImage && (
              <button
                ...
                className="w-full text-xs px-2 py-1.5 bg-[#f0efeb] hover:bg-red-50 rounded text-red-500"
              >
                도면 이미지 제거
              </button>
            )}
      ...
      <div className="p-3 mt-auto space-y-1.5">
        <p className="text-xs font-semibold text-[#888880] uppercase tracking-wide mb-2">파일</p>
        <button
        ...
        <button
          ...
          className="w-full text-xs px-2 py-1.5 bg-[#f0efeb] hover:bg-[#e8e8e0] rounded"
        >
          불러오기 (로컬)
        </button>
        <button
